...
namespace xDialog
{
    class MsgBox : Form
    {
        ...
        private MsgBox()
        {
            ...
            _lblTitle.Font = new System.Drawing.Font("华文行楷", 12);
            _lblTitle.Dock = DockStyle.Top;
            _lblTitle.Height = 50;

            _lblMessage = new Label();
            _lblMessage.ForeColor = Color.White;
            _lblMessage.Font = new System.Drawing.Font("华文行楷", 20);
        ...
        private static void InitButtons(Buttons buttons)
        {
            ...
            foreach (Button btn in _msgBox._buttonCollection)
            {
                ...
                btn.Font = new System.Drawing.Font("华文行楷", 8);
        ...
        private static Size MessageSize(string message)
        {
            ...
            SizeF size = g.MeasureString(message, new System.Drawing.Font("华文行楷", 12));
